...
'ojs/ojresponsiveknockoututils', 'ojs/ojcorerouter', 'ojs/ojmodulerouter-adapter', 'ojs/ojknockoutrouteradapter', 
'ojs/ojurlparamadapter', 'ojs/ojarraydataprovider', 'ojs/ojknockouttemplateutils', 'ojs/ojmodule-element', 'ojs/ojknockout'
,"ojs/ojnavigationlist",'appController'],
  function(ko, Context, moduleUtils, ResponsiveUtils, ResponsiveKnockoutUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ArrayDataProvider, KnockoutTemplateUtils) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'incidents', detail: { label: 'Incidents', iconClass: 'oj-ux-ico-cart' } },
      ...
      this.appName = ko.observable("FUEL");
